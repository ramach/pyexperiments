...
from typing import Union, BinaryIO, Tuple, List, Dict
import fitz  # PyMuPDF
import os
...
def retrieve_pdf_with_image_ocr(
    ...
    if pdf_input is None:
        raise ValueError("Missing PDF input. Please provide a valid file path or uploaded file object.")
